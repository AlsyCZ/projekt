        ...
        <div class="container mt-5">
            <div class="row justify-content-center">
                ...
                <h2 class="textik text-center mb-4">Přidat/Změnit Hardware</h2>
                    <form id="hardware-form" autocomplete="off" action="hardware_edit.php" method="post">
...
<script>
    function positionAutocompleteItems(inputElement, itemsElement) {
    var inputRect = inputElement[0].getBoundingClientRect();
    itemsElement.css({
        top: inputRect.bottom + window.pageYOffset + 'px',
...
$(document).ready(function() {
    ...
    $('#cpu, #mobo, #gpu').on('input', function() {
        var inputElement = $(this);
        var itemsElement = inputElement.next('.autocomplete-items');
        positionAutocompleteItems(inputElement, itemsElement);
    });
});
    $(document).ready(function() {
